...
class CasesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $case->imgs = empty($case->imgs)?$default_imgs:json_decode($case->imgs,true);
        $default_videos = [
            "img_url" => "/static/202108/c5b4c5ad9af9db4b41c119257a8cc9b9.jpg",
            "video_url" => "/uploads/files/202108/1.mp4",
        ];
        $case->videos = empty($case->videos)?$default_videos:json_decode($case->videos,true);
        if (request()->wantsJson()) {
