...
//                                 var r = e.map, c = r.id;
//                                 if (e.enabled && (r.isDefine || s.push(e), !e.error)) if (!e.inited && o) i(c) ? (t = !0, u = !0) : (a.push(c), n(c)); else if (!e.inited && e.fetched && r.isDefine && (u = !0, !r.prefix)) return f = !1
...
//                                 var i, o, f, d = getOwn(I, this.map.id), l = this.map.name,
...
//         }, l = function (e, t) {
//             if (a && a.addImport || u(), a && a.addImport) s ? f.push([e, t]) : (p(e), s = t); else {
...
//             c = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, f = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im,
//             p = "undefined" != typeof location && location.href,
//             d = p && location.protocol && location.protocol.replace(/\:/, ""), l = p && location.hostname,
//             h = p && (location.port || void 0), m = {}, g = e.config && e.config() || {};
//         return n = {
...
//                     var i;
//                     if (n.isBuild) buildMap[e] = t, r(t); else {
//                         try {
//                             i = jsonParse(t)
//                         } catch (e) {
//                             r.error(e)
...
//             var cos = Math.cos, lat1 = point1[1] * deg2rad, lon1 = point1[0] * deg2rad, lat2 = point2[1] * deg2rad,
//                 lon2 = point2[0] * deg2rad, dLat = lat2 - lat1, dLon = lon2 - lon1,
//                 a = (1 - cos(dLat) + (1 - cos(dLon)) * cos(lat1) * cos(lat2)) / 2;
//             return earthDiameter * Math.asin(Math.sqrt(a));
//         }
//
//         var scaleCache = {}, earthDiameter = 12756274, deg2rad = Math.PI / 180, rad2deg = 180 / Math.PI,
//             quadPI = Math.PI / 4, maxLat = 85.0511287798, half2PI = .5 / Math.PI;
//         return {
